...
namespace HangfireWebJobs.Models
{
    public class ServerConnection
    {
        ...
        public SqlBulkCopy SqlBulkQuery()
        {
            bulkCopy = new SqlBulkCopy(_con);
            return bulkCopy;
        }

        public void DestinationTable(string tableName)
        {
            bulkCopy.DestinationTableName = tableName;  
        }


        public void PushData(DataTable dt)
        {
        ...
        public string DataReaderSingleRow()
        {
            string max = "";
            _dr = Cmd.ExecuteReader();
            while(_dr.Read())
